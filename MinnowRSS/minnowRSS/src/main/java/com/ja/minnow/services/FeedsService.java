...
public class FeedsService {
    ...
    public boolean saveFeed(MinnowRSS activity) {
        ...
        try {
            ...
            // verify it's xml
            if (!Constants.getParser().isValidRSS(rssFeed)) {
                return false;
            }
    ...
    public void importRow(DatabaseAdapter adapter, Map<String, String> tableRow) {
        ...
        try {
            ...
            remap.putAll(tableRow);

            final long count = adapter.insert(FeedsTableData.FEEDS_TABLE, remap);
            Log.d(FE_TAG, "Number of feeds added: " + count);
