...
public class TableManager {
	...
	public String createTable() {
		Log.v(TABLE_TAG, "Entering create table with column count = " + columns.size());
		StringBuilder createTable = new StringBuilder();
		createTable.append("create table " + this.tableName + "(_id integer primary key autoincrement");
		if (columns.size() > 0) {
			createTable.append(", ");
		}
